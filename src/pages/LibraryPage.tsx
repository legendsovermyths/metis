...
export default function LibraryPage() {
  ...
  const { pendingUploads, booksVersion, pickAndUpload } = useBookUploads();

  useEffect(() => {
    setLoading(true);
    getAllBooks()
      .then((list) => setBooks(list.map(backendBookToDisplay)))
  ...
  return (
    <div className="paper-texture min-h-[calc(100vh-57px)] px-6 py-8 pb-24 md:pb-8">
      <div className="mx-auto max-w-4xl">
        ...
        {!loading && !loadError && filtered.length === 0 && pendingUploads.length === 0 && (
